...
\chapter{Implementation}\label{chapter:implementation}
    ...
    in Haskell. While the paper provided a good overview of the language and the
    translation, the lower-level details were omitted. That being said, two
    inherently different takes at implementations were made. The first one
    is based on curried translation and A. Appel~\cite{appel-continuations}
